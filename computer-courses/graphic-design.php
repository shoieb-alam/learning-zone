                ...
                <div class="row d-flex justify-content-between align-items-center py-3">
                    <div class="col-md-4">
                        ...
                        <ul class="text-start ms-5 fs-5">
                            ...
                            <li>02.
                                <a href="https://trydesignlab.com/" target="_blank">Design Lab</a>
                            </li>
                            <li>03.
                                <a href="https://creativepro.com/" target="_blank">Creative Pro</a>
                            </li>
                        </ul>

                    </div>
                    <div class="col-md-8">
                        <iframe width="590" height="380" src="https://www.youtube.com/embed/IJoCTVLAv38"
